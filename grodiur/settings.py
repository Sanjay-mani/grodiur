...
ALLOWED_HOSTS = ['*'] # In production, you should list your specific domain
...
# Silence the transition warning (W001) as our hybrid auth (OTP + Social) 
# intentionally uses different identifiers across flows.
